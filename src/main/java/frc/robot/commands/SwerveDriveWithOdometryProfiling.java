...
public class SwerveDriveWithOdometryProfiling extends CommandBase {
    ...
    // TODO: allow for passing in list of poses
    ...
    public void execute() {
        ...
        ChassisSpeeds speeds = ChassisSpeeds.fromFieldRelativeSpeeds(
            sum.getX(), sum.getY(), state.poseMeters.getRotation().getRadians(), Rotation2d.fromDegrees(Drivetrain.getInstance().getPigeon().getFusedHeading()));
